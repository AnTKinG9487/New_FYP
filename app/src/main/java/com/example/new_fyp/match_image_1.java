...
public class match_image_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_image1);
        ...
        question.setOnDragListener(new MyDragListener());
            ...
            switch (action) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (targetView.getId() == R.id.question && droppedView.getId() == R.id.answer1) {
                        ...
                        answer_1.setImageResource(R.drawable.sad);
                        ...
                        answer_2.setImageResource(R.drawable.sad_mouth_mouth);
                        ...
                        answer_3.setImageResource(R.drawable.sad_angry_eye);
                        Toast.makeText(getApplicationContext(), "Wrong", Toast.LENGTH_SHORT).show();
    ...
    private void resetGame() {
        ...
        view.findViewById(R.id.playagin).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(match_image_1.this, match_image_1.class);
        ...
        view.findViewById(R.id.backtomanu).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(match_image_1.this, home_page.class);
                startActivity(intent);
            }
        });
        alertDialog.show();
    ...
    private void endgame() {
        ...
        view.findViewById(R.id.playagin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(match_image_1.this, match_image_2.class);
                startActivity(intent);
            }
        });
        view.findViewById(R.id.backtomanu).setOnClickListener(new View.OnClickListener() {

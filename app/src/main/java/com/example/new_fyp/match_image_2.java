...
public class match_image_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_image2);
        ...
        question.setOnDragListener(new match_image_2.MyDragListener());
            ...
            switch (action) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (targetView.getId() == R.id.question && droppedView.getId() == R.id.answer1) {
                        ...
                        answer_1.setImageResource(R.drawable.angry_happy_eye);
...
//                                endgame();
                        ...
                        answer_2.setImageResource(R.drawable.angry_mouth_mouth);
                        Toast.makeText(getApplicationContext(), "Wrong", Toast.LENGTH_SHORT).show();
...
//                                endgame();
                        ...
                        answer_3.setImageResource(R.drawable.angry);
...
//                                resetGame();
    ...
    private void resetGame() {
        ...
        view.findViewById(R.id.playagin).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(match_image_2.this, match_image_2.class);
        ...
        view.findViewById(R.id.backtomanu).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(match_image_2.this, home_page.class);
                startActivity(intent);
            }
        });
        alertDialog.show();
    ...
    private void endgame() {
        ...
        view.findViewById(R.id.playagin).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(match_image_2.this, match_image_3.class);
                startActivity(intent);
            }
        });
        view.findViewById(R.id.backtomanu).setOnClickListener(new View.OnClickListener() {
